...
void RS485_SendAddressByte(uint8_t u8data)
{
    UART_SetLine_Config(UART, 0, UART_WORD_LEN_8, UART_PARITY_MARK, UART_STOP_BIT_1);
    UART_WRITE(UART,u8data);
}

void RS485_SendDataByte(uint8_t *pu8TxBuf, uint32_t u32WriteBytes)
{
    UART_SetLine_Config(UART, 0, UART_WORD_LEN_8, UART_PARITY_SPACE, UART_STOP_BIT_1);
    UART_WriteBytes(UART,pu8TxBuf,u32WriteBytes);
}
...
void RS485_9bitModeSlave()
{
    ...
    UART->FCR |= UART_FCR_RFITL_1BYTE;
        ...
        /* Set RS485-NMM Mode */
        UART_SelectRS485Mode(UART, UART_ALT_CSR_RS485_NMM_Msk|UART_ALT_CSR_RS485_ADD_EN_Msk, 0);
        ...
        UART_SelectRS485Mode(UART, UART_ALT_CSR_RS485_AAD_Msk|UART_ALT_CSR_RS485_ADD_EN_Msk, MATCH_ADDRSS1);
    #endif
