 ...
 * @version  V2.00
 * $Date: 13/10/07 3:57p $ 
 * @brief    MINI51 Series Global Control and Clock Control Driver Sample Code
 *
 * @note
...
int32_t main (void)
{
    ...
    /* If define INIT_CLK_AT_BOOTING in system_Mini51.h, HCLK will be set to 50MHz in SystemInit(void)*/
    ...
    /*
        ...
        3. Setting about BOD
        4. Outout system clock from CKO pin, and the output frequency = system clock / 4  
    */
