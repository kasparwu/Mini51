...
#line 264 "C:\\Keil\\ARM\\CMSIS\\Include\\core_cmInstr.h"



#line 615 "C:\\Keil\\ARM\\CMSIS\\Include\\core_cmInstr.h"
...
void SYS_Init(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCON |= 0x01UL | (1ul << 2);

     
    CLK_WaitClockReady((1ul << 0) | (1ul << 4));

     
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL0 = 0x00UL | 0x00UL;

     
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->APBCLK = (1ul << 12) | (1ul << 16);
    ...
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->P0_MFP = 0x00000202UL | 0x00000101UL;
...
void UART_Init(void)
{
    ...
    ((UART_T *) (((uint32_t)0x40000000) + 0x50000))->LCR = 0x3 | (0x0 << 3) | (0x0 << 2) ;
}
...
void SpiLoopbackTest(void)
{
    ...
    for(u32TestCount=0; u32TestCount<100; u32TestCount++)
    {
        ...
        while(1)
        {
            SPI_WRITE_TX(((SPI_T *) (((uint32_t)0x40000000) + 0x30000)), g_au32SourceData[u32DataCount]);
            SPI_TRIGGER(((SPI_T *) (((uint32_t)0x40000000) + 0x30000)));
            while(SPI_IS_BUSY(((SPI_T *) (((uint32_t)0x40000000) + 0x30000))));

            g_au32DestinationData[u32DataCount] = SPI_READ_RX(((SPI_T *) (((uint32_t)0x40000000) + 0x30000)));
            u32DataCount++;
            if(u32DataCount > 64)    break;
        }
