...
void SYS_Init(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->APBCLK = (1ul << 16) | (1ul << 2) | (1ul << 3); 

     
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL1 = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL1 & ~(3ul << 24)) | 0x00000000UL;
    ...
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->P0_MFP = 0x00000101UL | 0x00000202UL;
...
void Timer_Init(void)
{
    ...
    TIMER_Open(((TIMER_T *) (((uint32_t)0x40000000) + 0x10000)), (2UL << 27), Timer_Constant);
    TIMER_Start(((TIMER_T *) (((uint32_t)0x40000000) + 0x10000)));

	TIMER_Open(((TIMER_T *) (((uint32_t)0x40000000) + 0x10020)),(2UL << 27),Timer_Constant*2);
    ...
    if(u32IntSts & (1ul << 8))
        ...
        while(((((UART_T *) (((uint32_t)0x40000000) + 0x50000))->ISR & (1ul << 0))>>0)) 
			...
			if(UART_ReadCounter>2) 
				...
				{
				UART_Buffer[UART_ReadCounter] = (((UART_T *) (((uint32_t)0x40000000) + 0x50000))->RBR);		   
				(((UART_T *) (((uint32_t)0x40000000) + 0x50000))->THR = (UART_Buffer[UART_ReadCounter]));		  
				UART_ReadCounter++;
				}
